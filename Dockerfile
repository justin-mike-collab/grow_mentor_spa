...
ARG GITHUB_TOKEN
RUN echo "@justin-mike-collab:registry=https://npm.pkg.github.com" > .npmrc && \
...
LABEL org.opencontainers.image.source="https://github.com/justin-mike-collab/grow_mentor_spa"

ENV API_HOST=grow_mentor_api
ENV API_PORT=8391
