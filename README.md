...
## Prerequisites
- grow [Developers Edition](https://github.com/justin-mike-collab/grow/blob/main/CONTRIBUTING.md)
- Developer [SPA Standard Prerequisites](https://github.com/justin-mike-collab/grow/blob/main/DeveloperEdition/standards/spa_standards.md)
...
**Note**: This template uses `@justin-mike-collab/grow_spa_utils` for reusable components, composables, and utilities. See the [spa_utils README](../spa_utils/README.md) for complete documentation on available components (`AutoSaveField`, `AutoSaveSelect`, `ListPageSearch`), composables (`useResourceList`, `useErrorHandler`, `useRoles`), and utilities (`formatDate`, `validationRules`).
...
This template uses components and composables from `@ajustin-mike-collab/grow_spa_utils`:
